                    ...
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            <a class="has-arrow" href="index.html">
								   ...
								   <span class="mini-click-non">Quản lý thông tin</span>
								</a>
                            <ul class="submenu-angle" aria-expanded="true">
                                <li><a title="Dashboard v.1" href="index-sinhvien-xeminfor.php"><span class="mini-sub-pro">Xem thông tin</span></a></li>
                                <li><a title="Dashboard v.2" href="index-sinhvien-edit.php?id=<?php echo $_SESSION["idsohuu"]?>"><span class="mini-sub-pro">Sửa thông tin</span></a></li>

                            </ul>
                        </li>
                        <li>
                            <a class="has-arrow" href="../html/mailbox.html" aria-expanded="false"><i class="icon nalika-mail icon-wrap"></i> <span class="mini-click-non">Tuyển dụng</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="Inbox" href="index-sinhvien-vitri.php"><span class="mini-sub-pro">Vị trí dang tuyển</span></a></li>
                                <li><a title="View Mail" href="index-sinhvien-ungtuyen.php"><span class="mini-sub-pro">Ứng tuyển</span></a></li>
                                        ...
                                        <div class="header-top-menu tabl-d-n hd-search-rp">
                                            <div class="breadcome-heading">
												<form role="search" class="">
													<input type="text" placeholder="Search..." class="form-control" readonly>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div style="height: 220px">
                        <h1 style="margin-top: 120px">Thao Tác thành công</h1>
