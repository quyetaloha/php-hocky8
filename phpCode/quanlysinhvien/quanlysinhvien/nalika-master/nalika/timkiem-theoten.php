    ...
    <div class="product-sales-area mg-tb-30">
        <div class="container-fluid">
            <div class="row" style="height: 340px">
                <form  style="margin-left: 400px;color:black;margin-top: 70px;font-size: 20px;font-weight: bold" action="timkiem-ketqua-theoten.php" method="get">
                    <input name="search" type="text" placeholder="nhập id cần tìm kiếm">
                    <button style="height: 33px" type="submit" >Tìm kiếm</button>
                </form>
            </div>
